...
from Hottie_Robot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
...
buttons = [
    [
                        InlineKeyboardButton(
                            text=f"Add Hottie To Your Group",
                            url=f"t.me/Hottie_Robot?startgroup=true")
                    ],
                   [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Hottie_Robot.modules." +
                                              module_name)
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I Am Now Online!](https://telegra.ph/file/7cab440852751e60368c1.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
