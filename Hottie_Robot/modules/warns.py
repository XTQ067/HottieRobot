...
RESET_WARN_HANDLER = CommandHandler(
    ["resetwarn", "resetwarns"], reset_warns, filters=Filters.chat_type.groups, run_async=Trur
)
...
REMOVE_WARN_HANDLER = CommandHandler("rmwarn", rmwarn_cmd, filters=Filters.chat_type.groups, run_async=True)
